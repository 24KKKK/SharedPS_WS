...
public class Count {
	 ...
	 * @return double cost
	 */
	public static double getCostMoney(String starttime, String endtime, String startdate, String enddate) {
		int a[] = new int[3];
		String start = startdate+" "+starttime+":00";
		String end = enddate+" "+endtime+":00";
		String format = "yyyy-MM-dd HH:mm:ss";
		a=dateDiff(start, end, format);
	...
	public static void main(String[] args) {
		getCostMoney("12:36", "13:00", "2018-4-19", "2018-4-22");
	}
